...
public class DeleteBookCommand implements Command {
    ...
    public DeleteBookCommand(Input input, Output output, BookRepository bookRepository) {
        this.input = input;
        this.output = output;
    ...
    @Override
    public void execute() {
        this.output.result(this.bookRepository.deleteBook(this.input.isbn().toString()));
    }
