...
SET /P STACK_NAME_ECR=Ingrese el nombre de la pila de ECR:
...
aws cloudformation wait stack-create-complete --stack-name %STACK_NAME_ECR%
...
call ../../monolith/upload-docker.bat

SET /P STACK_NAME=Ingrese el nombre de la pila con API Gateway y ECS + RDS:
